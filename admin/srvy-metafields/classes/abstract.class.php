 ...
 *
 */
if ( ! class_exists( 'SRVY_Abstract' ) ) {
  abstract class SRVY_Abstract {
    ...
    public function __construct() {
      ...
      if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
        ...
        SRVY::$css = apply_filters( "srvy_{$this->unique}_output_css", SRVY::$css, $this );
      }
    ...
    public function recursive_output_css( $fields = array(), $combine_field = array() ) {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          $field_class  = 'SRVY_Field_' . $field_type;
