 ...
 *
 */
if ( ! class_exists( 'SRVY_Field_sorter' ) ) {
  class SRVY_Field_sorter extends SRVY_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        'disabled'       => true,
        'enabled_title'  => esc_html__( 'Enabled', 'srvy' ),
        'disabled_title' => esc_html__( 'Disabled', 'srvy' ),
      ) );
      ...
      echo '<div class="srvy-sorter" data-depend-id="'. esc_attr( $this->field['id'] ) .'"></div>';

      echo ( $args['disabled'] ) ? '<div class="srvy-modules">' : '';

      echo ( ! empty( $args['enabled_title'] ) ) ? '<div class="srvy-sorter-title">'. esc_attr( $args['enabled_title'] ) .'</div>' : '';
      echo '<ul class="srvy-enabled">';
      ...
      if ( $args['disabled'] ) {
        ...
        echo '<div class="srvy-modules">';
        echo ( ! empty( $args['disabled_title'] ) ) ? '<div class="srvy-sorter-title">'. esc_attr( $args['disabled_title'] ) .'</div>' : '';
        echo '<ul class="srvy-disabled">';
