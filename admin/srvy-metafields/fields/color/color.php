 ...
 *
 */
if ( ! class_exists( 'SRVY_Field_color' ) ) {
  class SRVY_Field_color extends SRVY_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="srvy-color"'. $default_attr . $this->field_attributes() .'/>';
