 ...
 *
 */
if ( ! class_exists( 'SRVY_Field_sortable' ) ) {
  class SRVY_Field_sortable extends SRVY_Fields {
    ...
    public function render() {
      ...
      echo '<div class="srvy-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="srvy-sortable-item">';

          echo '<div class="srvy-sortable-content">';
          ...
          SRVY::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="srvy-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
