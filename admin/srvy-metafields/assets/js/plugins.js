...
(function($) {
  ...
  function SRVYAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  SRVYAjaxChosen.prototype.init = function() {
  ...
  SRVYAjaxChosen.prototype.events = function() {
  ...
  SRVYAjaxChosen.prototype.search_field_focused = function() {
  ...
  SRVYAjaxChosen.prototype.search_welcome_message = function() {
  ...
  SRVYAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('srvy-chosen', _this.options.data).done( function( response ) {
  ...
  SRVYAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.srvy-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.SRVYChosenOrder($hidden_value, true);
  ...
  $.fn.SRVYAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new SRVYAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, SRVYAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  SRVYAbstractChosenOrder = (function() {

    function SRVYAbstractChosenOrder() {}

    SRVYAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    SRVYAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    SRVYAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    SRVYAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    SRVYAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    SRVYAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    SRVYAbstractChosenOrder.SRVYChosenOrder = function(select, order, force) {
    ...
    return SRVYAbstractChosenOrder;
  ...
  $.fn.extend({
    SRVYChosenOrder: function(order, force) {
      return _SRVYChosenOrder.SRVYChosenOrder(this, order, force);
    }
  });

  this._SRVYChosenOrder = (function(_super) {
    __extends(_SRVYChosenOrder, _super);

    function _SRVYChosenOrder() {
      _ref = _SRVYChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _SRVYChosenOrder.relAttributeName = 'data-option-array-index';

    _SRVYChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _SRVYChosenOrder.getDOMElement = function(element) {
    ...
    _SRVYChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _SRVYChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _SRVYChosenOrder;

  })(SRVYAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('srvy-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectSRVY = FormSerializer.serializeObject;
    $.fn.serializeJSONSRVY   = FormSerializer.serializeJSON;
  }
