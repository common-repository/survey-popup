...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.srvy_gutenberg_blocks ) { return; }

  Object.values(window.srvy_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType(block.name, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'srvy-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.name,
              className: 'is-secondary srvy-shortcode-button',
              onClick: function () {
                window.srvy_gutenberg_props = props;
              },
            }, block.button_title ),
